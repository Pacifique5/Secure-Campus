...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen overflow-hidden transition-colors duration-300 ${darkMode ? 'dark bg-gray-900' : 'bg-white'}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#contact" className={`${darkMode ? 'text-gray-300 hover:text-blue-400' : 'text-gray-700 hover:text-blue-600'} font-medium transition-all hover:scale-110`}>Contact</a>
      ...
      <div id="analytics" className={`py-20 ${darkMode ? 'bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900' : 'bg-gradient-to-br from-gray-50 to-blue-50'} relative overflow-hidden`}>
        {/* Animated Grid Background */}
        <div className={`absolute inset-0 ${darkMode ? 'opacity-10' : 'opacity-5'}`}>
          <div className="absolute inset-0" style={{
            backgroundImage: `linear-gradient(${darkMode ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.05)'} 1px, transparent 1px), linear-gradient(90deg, ${darkMode ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.05)'} 1px, transparent 1px)`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className={`text-xl ${darkMode ? 'text-blue-200' : 'text-gray-600'}`}>
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-12">
            <div className={`group relative ${darkMode ? 'bg-gradient-to-br from-blue-500/20 to-blue-600/20 backdrop-blur-sm border-blue-400/30 hover:border-blue-400/60' : 'bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 hover:border-blue-300'} p-6 rounded-2xl border transition-all hover:scale-105 cursor-default overflow-hidden shadow-lg`}>
              <div className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-blue-400/0 to-blue-600/20' : 'bg-gradient-to-br from-blue-100/0 to-blue-200/50'} opacity-0 group-hover:opacity-100 transition-opacity`}></div>
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <div className={`text-sm font-semibold px-3 py-1 rounded-full ${darkMode ? 'text-blue-300 bg-blue-500/30' : 'text-blue-700 bg-blue-200'}`}>+12%</div>
                  <div className="text-2xl">👥</div>
                </div>
                <div className={`text-4xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} mb-1 group-hover:scale-110 transition-transform`}>2,847</div>
                <div className={`text-sm ${darkMode ? 'text-blue-200' : 'text-gray-600'}`}>Total Students</div>
              </div>
            </div>

            <div className={`group relative ${darkMode ? 'bg-gradient-to-br from-green-500/20 to-emerald-600/20 backdrop-blur-sm border-green-400/30 hover:border-green-400/60' : 'bg-gradient-to-br from-green-50 to-emerald-100 border-green-200 hover:border-green-300'} p-6 rounded-2xl border transition-all hover:scale-105 cursor-default overflow-hidden shadow-lg`}>
              <div className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-green-400/0 to-emerald-600/20' : 'bg-gradient-to-br from-green-100/0 to-emerald-200/50'} opacity-0 group-hover:opacity-100 transition-opacity`}></div>
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <div className={`text-sm font-semibold px-3 py-1 rounded-full ${darkMode ? 'text-green-300 bg-green-500/30' : 'text-green-700 bg-green-200'}`}>+2.4%</div>
                  <div className="text-2xl">✓</div>
                </div>
                <div className={`text-4xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} mb-1 group-hover:scale-110 transition-transform`}>94.2%</div>
                <div className={`text-sm ${darkMode ? 'text-green-200' : 'text-gray-600'}`}>Today's Attendance</div>
              </div>
            </div>

            <div className={`group relative ${darkMode ? 'bg-gradient-to-br from-purple-500/20 to-pink-600/20 backdrop-blur-sm border-purple-400/30 hover:border-purple-400/60' : 'bg-gradient-to-br from-purple-50 to-pink-100 border-purple-200 hover:border-purple-300'} p-6 rounded-2xl border transition-all hover:scale-105 cursor-default overflow-hidden shadow-lg`}>
              <div className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-purple-400/0 to-pink-600/20' : 'bg-gradient-to-br from-purple-100/0 to-pink-200/50'} opacity-0 group-hover:opacity-100 transition-opacity`}></div>
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <div className={`text-sm font-semibold px-3 py-1 rounded-full ${darkMode ? 'text-purple-300 bg-purple-500/30' : 'text-purple-700 bg-purple-200'}`}>+0.3%</div>
                  <div className="text-2xl">🛡️</div>
                </div>
                <div className={`text-4xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} mb-1 group-hover:scale-110 transition-transform`}>99.8%</div>
                <div className={`text-sm ${darkMode ? 'text-purple-200' : 'text-gray-600'}`}>Security Score</div>
              </div>
            </div>

            <div className={`group relative ${darkMode ? 'bg-gradient-to-br from-orange-500/20 to-red-600/20 backdrop-blur-sm border-orange-400/30 hover:border-orange-400/60' : 'bg-gradient-to-br from-orange-50 to-red-100 border-orange-200 hover:border-orange-300'} p-6 rounded-2xl border transition-all hover:scale-105 cursor-default overflow-hidden shadow-lg`}>
              <div className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-orange-400/0 to-red-600/20' : 'bg-gradient-to-br from-orange-100/0 to-red-200/50'} opacity-0 group-hover:opacity-100 transition-opacity`}></div>
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <div className={`text-sm font-semibold px-3 py-1 rounded-full ${darkMode ? 'text-orange-300 bg-orange-500/30' : 'text-orange-700 bg-orange-200'}`}>+8%</div>
                  <div className="text-2xl">⚡</div>
                </div>
                <div className={`text-4xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} mb-1 group-hover:scale-110 transition-transform`}>1,234</div>
                <div className={`text-sm ${darkMode ? 'text-orange-200' : 'text-gray-600'}`}>Active Sessions</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className={`${darkMode ? 'bg-white/10 backdrop-blur-md border-white/20 hover:border-white/40' : 'bg-white border-gray-200 hover:border-gray-300'} p-8 rounded-2xl border transition-all shadow-xl`}>
              <div className="flex items-center justify-between mb-6">
                <h3 className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Attendance Wave</h3>
                <span className={`text-sm px-3 py-1 rounded-full ${darkMode ? 'text-blue-300 bg-blue-500/30' : 'text-blue-700 bg-blue-100'}`}>Last 30 Days</span>
              </div>
              <div className="h-64 flex items-end justify-between gap-1">
                {[85, 92, 88, 95, 90, 94, 96, 93, 91, 94, 97, 95, 92, 94, 96, 98, 94, 93, 95, 97, 96, 94, 95, 93, 94, 96, 95, 94, 93, 95].map((value, index) => (
                  <div key={index} className="group flex-1 relative">
                    <div 
                      className={`w-full ${darkMode ? 'bg-gradient-to-t from-cyan-500 via-blue-500 to-indigo-500 hover:from-cyan-400 hover:via-blue-400 hover:to-indigo-400' : 'bg-gradient-to-t from-blue-400 via-blue-500 to-indigo-600 hover:from-blue-500 hover:via-blue-600 hover:to-indigo-700'} rounded-t-lg transition-all duration-500 cursor-pointer shadow-lg`}
                      style={{ 
                        height: `${value}%`,
                        animationDelay: `${index * 50}ms`
                      }}
                    >
                      <div className={`absolute -top-8 left-1/2 transform -translate-x-1/2 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-800 text-white'} text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap`}>
                        {value}%
                      </div>
                    </div>
                  </div>
              ...
              <div className={`flex justify-between mt-4 text-xs ${darkMode ? 'text-blue-300' : 'text-gray-600'}`}>
                <span>Day 1</span>
                <span>Day 15</span>
                <span>Day 30</span>
              </div>
            ...
            <div className={`${darkMode ? 'bg-white/10 backdrop-blur-md border-white/20 hover:border-white/40' : 'bg-white border-gray-200 hover:border-gray-300'} p-8 rounded-2xl border transition-all shadow-xl`}>
              <h3 className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} mb-6`}>Department Distribution</h3>
              <div className="flex items-center justify-center">
                <div className="relative w-56 h-56">
                  <svg viewBox="0 0 200 200" className="transform -rotate-90">
                    {/* Engineering - 35% */}
                    <circle cx="100" cy="100" r="80" fill="none" stroke="#3b82f6" strokeWidth="40" strokeDasharray="175.93 502.65" strokeDashoffset="0" className="transition-all hover:stroke-width-45 cursor-pointer" />
                    {/* Science - 25% */}
                    <circle cx="100" cy="100" r="80" fill="none" stroke="#8b5cf6" strokeWidth="40" strokeDasharray="125.66 502.65" strokeDashoffset="-175.93" className="transition-all hover:stroke-width-45 cursor-pointer" />
                    {/* Arts - 20% */}
                    <circle cx="100" cy="100" r="80" fill="none" stroke="#ec4899" strokeWidth="40" strokeDasharray="100.53 502.65" strokeDashoffset="-301.59" className="transition-all hover:stroke-width-45 cursor-pointer" />
                    {/* Business - 20% */}
                    <circle cx="100" cy="100" r="80" fill="none" stroke="#f59e0b" strokeWidth="40" strokeDasharray="100.53 502.65" strokeDashoffset="-402.12" className="transition-all hover:stroke-width-45 cursor-pointer" />
                  </svg>
                  <div className={`absolute inset-0 flex items-center justify-center flex-col`}>
                    <div className={`text-3xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>2,847</div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className={`text-sm font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Engineering</div>
                    <div className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>35% (996)</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded-full bg-purple-500"></div>
                  <div>
                    <div className={`text-sm font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Science</div>
                    <div className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>25% (712)</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded-full bg-pink-500"></div>
                  <div>
                    <div className={`text-sm font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Arts</div>
                    <div className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>20% (569)</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded-full bg-amber-500"></div>
                  <div>
                    <div className={`text-sm font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Business</div>
                    <div className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>20% (570)</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Contact Section */}
      <div id="contact" className={`py-20 ${darkMode ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-black' : 'bg-gradient-to-br from-gray-50 to-white'} relative overflow-hidden`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className={`text-lg ${darkMode ? 'text-gray-400' : 'text-gray-600'} mb-8 leading-relaxed`}>
                Ready to transform your campus security? Whether you're interested in implementing SecureCampus at your institution, have questions about our features, or want to schedule a demo, we're here to help. Reach out and let's discuss how we can secure your campus together!
              </p>
              
              {/* Social Links */}
              <div className="flex items-center gap-4">
                <a 
                  href="mailto:hello@securecampus.com" 
                  className={`w-12 h-12 ${darkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-200 hover:bg-gray-300'} rounded-full flex items-center justify-center transition-all hover:scale-110`}
                >
                ...
                <a 
                  href="https://linkedin.com/company/securecampus" 
                  target="_blank" 
                ...
                <a 
                  href="https://twitter.com/securecampus" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className={`w-12 h-12 ${darkMode ? 'bg-gray-800 hover:bg-gray-700' : 'bg-gray-200 hover:bg-gray-300'} rounded-full flex items-center justify-center transition-all hover:scale-110`}
                >
            ...
            <div className={`${darkMode ? 'bg-gray-800/50 backdrop-blur-xl border-gray-700' : 'bg-white border-gray-200'} p-8 rounded-2xl shadow-2xl border`}>
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 ${darkMode ? 'bg-gray-900 border-gray-700 text-white placeholder-gray-500' : 'bg-gray-50 border-gray-300 text-gray-900 placeholder-gray-400'} border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all`}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 ${darkMode ? 'bg-gray-900 border-gray-700 text-white placeholder-gray-500' : 'bg-gray-50 border-gray-300 text-gray-900 placeholder-gray-400'} border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none`}
                  ></textarea>
                </div>

                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition-all hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2"
                >
                  Send Message
